    ...
    <div class="card text-white mb-3 user-left-menu" >
        ...
        <div  class="list-group pb-4">
            ...
            <a href="#menu1" class="list-group-item collapsed" data-toggle="collapse" data-parent="#sidebar"
               aria-expanded="false"><i class="fa fa-hospital-o"></i> <span class="hidden-sm-down"> Twój klub</span> </a>
            <div class="collapse" id="menu1">
                <a href="{{url('/dashboard/clubs')}}" class="list-group-item child" data-parent="#menu1">Lista klubów</a>
                <a href="{{url('/dashboard/clubs/create')}}" class="list-group-item child" data-parent="#menu1">Dodaj nowy klub</a>
            </div>
