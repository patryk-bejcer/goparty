        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-7" style="padding-top: 0px;">
                ...
                <div class="description-footer">
                    <a href="#"><i class="fa fa-globe" style="margin-right: 5px"> </i> <span style="color: white; ">wojewodztwo: </span>{{$club->voivodeship}}
                    </a>
                    <a href="#"><i class="fa fa-globe" style="margin-right: 5px"> </i> <span style="color: white; ">Ulica: </span>{{$club->route}}{{$club->street_number}}
                    </a>
                </div>
                            ...
                            <div class="col-lg-12 event" style="padding-top:1rem; padding-bottom: 1rem">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-11">
                                        ...
                                        <p id="event-date">{{substr($event->start_date,0,10)}} <span class="pull-right">{{rand(200,9000)}}
                                                osób</span></p>
                                ...
                                <a style=" font-size: 20px;"
                                   class="mt-3 myBtn-link myBtn hvr-sweep-to-right animated fadeIn">Zobacz wiecej</a>
                            </div>
